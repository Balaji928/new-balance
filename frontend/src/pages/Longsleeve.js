...
import './Longsleeve.css'
import Longsleeves from '../products/Longsleeves'
...
const Longsleeve = () => {
  ...
  return (
      ...
      <section class="bred">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Long Sleeve</li>
          </ol>
        </nav>
      </section>
    ...
    <section>
      <div class="row ls2 mb-5">
        {Longsleeves.map((item)=>
